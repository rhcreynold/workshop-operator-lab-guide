...
extlinks = {
        ...
        'cc_by': ('https://creativecommons.org/licenses/by/4.0/%s', ''),
        'quay': ('https://quay.io/repository/jduncan/operator-workshop-lab-guide-ansible-for-devops/%s', ''),
        }
...
htmlhelp_basename = 'AnsibleforDevOpsdoc'
...
latex_documents = [
    (master_doc, 'AnsibleforDevOps.tex', u'Ansible for DevOps Documentation',
...
man_pages = [
    (master_doc, 'ansiblefordevops', u'Ansible for DevOps Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'AnsibleforDevOps', u'Ansible for DevOps Documentation',
     author, 'AnsibleforDevOps', 'One line description of project.',
     'Miscellaneous'),
]
